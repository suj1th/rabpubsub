...
public class PublisherConnectionConfig {
	...
	private final static Logger LOGGER = Logger.getLogger(PublisherConnectionConfig.class);
	 ...
	 */
	public PublisherConnectionConfig(){
		Class<?> claas;
		try {
